...
FROM mcr.microsoft.com/dotnet/sdk:7.0.406-bullseye-slim AS restore
WORKDIR /src
COPY ./*.sln ./
COPY */*.csproj ./
...
RUN dotnet publish "./doppler-integrations-msa/doppler-integrations-msa.csproj" -c Release -o /app/publish
...
ENTRYPOINT ["dotnet", "doppler-integrations-msa.dll"]
LABEL name="doppler-integrations-msa" version="$version"
